...
export default function Home() {
  return (
    <>
      <nav className="navbar bg-light fixed-top d-lg-none">
        <div className="container-fluid">
          <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
            <span className="navbar-toggler-icon"></span>
          </button>
          <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style={{height:'50%'}}>
      ...
      <div className="container">
        <div className="header">
          ...
          <div className="col-lg-5 custom1">
            ...
            <div className="col-lg-5 custom2 d-none d-lg-block">
      ...
      <div className="backg" style={{ overflow: "hidden"}}>
        <div className="container">
          <div>
            <div className="text">
              TREATY HEALTH IS THE GO-TO SYSTEM TO IMPROVE YOUR TEAM'S COMMUNICATION, WHILE
            </div>
