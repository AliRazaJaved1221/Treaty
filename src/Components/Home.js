  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="row main-sec pt-1 pb-1">
        ...
        <div className=" custom1">
            ...
            <div className="align-items-center justify-content-end custom2 d-none d-lg-block">
            ...
            <nav className="bttn navbar bg-light d-md-none d-lg-none">
        <div className="container-fluid">
          <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
          <span className="navbar-toggler-icon" ></span>
          </button>
          <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel"style={{ height: "100%", width:'50%'}}>
